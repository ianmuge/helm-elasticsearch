...
{{- define "elasticsearch.initialNodes" -}}
{{- $nodeCount := .Values.statefulSet.replicaCount | int }}
{{- $nodes := list }}
{{- range until $nodeCount }}
{{- $nodes = printf "%s-%d" $.Values.statefulSet.name . | append $nodes -}}
{{- end -}}
{{- join "," $nodes -}}
{{- end -}}